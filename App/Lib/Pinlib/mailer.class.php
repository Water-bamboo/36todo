...
class mailer
{
    ...
    public function get_instance($name = '') {
        if (!isset(self::$mailer_server[$name])) {
            ...
            $mailer_gw = array(
                'Mailer'=>"smtp",//$mail_config['mode'],
                'From' => "noreply@36todo.com",//$mail_config['from'],
                'FromName' => "36todo客服团队",//$mail_config['from_name'],
                'Host' => "mail.36todo.com",//$mail_config['host'],
                'Port' => 25,//$mail_config['port'],
                'Username' => "noreply@36todo.com",//$mail_config['auth_username'],
                'Password' => "norePly@1",//$mail_config['auth_password'],
            );
